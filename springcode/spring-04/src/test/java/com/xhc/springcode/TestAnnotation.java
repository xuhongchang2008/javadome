...
import com.xhc.springcode.four.Account;
import com.xhc.springcode.four.AppConfig10;
...
public class TestAnnotation {
    ...
    public void test1() {
        ...
        //ApplicationContext ctx = new AnnotationConfigApplicationContext("com.xhc.springcode");
    }
    ...
    @Test
    public void test9() {
        ApplicationContext ctx = new AnnotationConfigApplicationContext("com.xhc.springcode.config");
        UserDAO userDAO = (UserDAO) ctx.getBean("userDAO");
        UserService userService = (UserService) ctx.getBean("userService");
    ...
    @Test
    public void test10() {
        ApplicationContext ctx = new AnnotationConfigApplicationContext(com.xhc.springcode.config.AppConfig1.class);
        UserDAO userDAO = (UserDAO) ctx.getBean("userDAO");
        UserService userService = (UserService) ctx.getBean("userService");
        /*System.out.println("userService = " + userService);
        System.out.println("userDAO = " + userDAO);
    ...
    @Test
    public void test11() {
        ApplicationContext ctx = new AnnotationConfigApplicationContext(com.xhc.springcode.config.AppConfig3.class);
        UserService userService = (UserService) ctx.getBean("userService");
...
*/
    ...
    @Test
    public void test12() {
        ApplicationContext ctx = new AnnotationConfigApplicationContext(com.xhc.springcode.config.AppConfig4.class);
        UserService userService = (UserService) ctx.getBean("userService");
