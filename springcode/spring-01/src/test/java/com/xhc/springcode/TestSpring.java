...
import com.xhc.springcode.basic.BeanFactory;
import com.xhc.springcode.basic.Person;
import com.xhc.springcode.basic.User;
import com.xhc.springcode.basic.UserService;
import com.xhc.springcode.basic.constructer.Customer;
import com.xhc.springcode.beanpost.Categroy;
import com.xhc.springcode.factorybean.ConnectionFactoryBean;
import com.xhc.springcode.life.Product;
import com.xhc.springcode.scope.Account;
...
//        UserService userService = new UserServiceImpl();
   ...
   public void test10() {
       ...
       userService.register(new User("suns", "root"));
   ...
   public void test18() {
       ...
       com.xhc.springcode.converter.Person person = (com.xhc.springcode.converter.Person) ctx.getBean("person");
